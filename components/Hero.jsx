...
const Hero = () => {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      <img
        className="absolute w-full h-[calc(100vh+120px)] object-cover object-top"
        src="heobck.jpg"
        alt="Hero Background"
      />
      ...
      <div className="absolute lg:left-[-50px] md:left-[-20px] left-1/2  lg:bottom-[-180px] md:bottom-[-120px] bottom-[-90px] transform md:-translate-x-0 -translate-x-1/2 -translate-y-1/2">
        <img
      ...
      <div className="absolute lg:right-[-80px] md:right-[-80px] right-[-50px] lg:bottom-[-210px] md:bottom-[-150px] bottom-[-110px] transform -translate-y-1/2 md:block hidden">
        <img
