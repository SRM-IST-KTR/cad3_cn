					...
					<div className="flex items-center justify-between h-16">
						...
						<div className="hidden md:block">
							<div className="flex items-center space-x-8">
								<Link
									href="/About"
									className="text-white  font-bold hover:text-red-500 px-3 py-2 text-sm transition-colors">
									About
								</Link>
								<Link
									href="/prize"
									className="text-white hover:text-red-500 px-3 py-2 text-sm font-bold transition-colors">
									Prize
								</Link>
								<Link
									href="/timeline"
